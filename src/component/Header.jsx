...
const NotificationModal = ({ show, title, message, name, location, onAction }) => {
  if (!show) return null;
...
const Header = () => {
  ...
  const saveNotification = (action, homeKey = deviceKey, user = auth.currentUser.displayName, uid = auth.currentUser.uid) => {
